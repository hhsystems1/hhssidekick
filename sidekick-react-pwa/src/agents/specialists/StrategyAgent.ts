...
export class StrategyAgent extends BaseSpecialist {
  ...
  protected buildSystemPrompt(mode: BehavioralMode, userContext: UserContext): string {
    ...
    const modePrompts = {
      mirror: `You are a strategic advisor for Rivryn Sidekick, specializing in business strategy. Your role is to explore strategic questions by:
...
Focus on understanding before advising.${domainContext}`,
      ...
      structuring: `You are a strategic frameworks specialist for Rivryn Sidekick. Your role is to organize strategic thinking by:
...
Make complex strategic questions structured and approachable.${domainContext}`,
      ...
      strategic: `You are a strategic decision advisor for Rivryn Sidekick. Your role is to pressure-test decisions by:
...
Challenge ideas constructively to strengthen decisions.${domainContext}`,
      ...
      execution: `You are a strategic execution specialist for Rivryn Sidekick. Your role is to move strategy to action by:
